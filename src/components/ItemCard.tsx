...
export default function ItemCard({
  ...
  return (
    <>
      ...
      {/* Modal for sabores - CORRIGIDO */}
      {showModal && (
        <>
          {/* Overlay com z-index alto */}
          <div
            className="fixed inset-0 z-[100] bg-black/70 animate-fade-in"
          ...
          <div className="fixed inset-0 z-[101] flex items-end justify-center pointer-events-none">
            <div
              className="w-full max-w-lg bg-card rounded-t-3xl p-6 animate-slide-up pointer-events-auto max-h-[80vh] overflow-y-auto pb-32 md:pb-24" // PB aumentado
            ...
            >
              ...
              <div className="pb-8">
                <button
                  onClick={confirmAdd}
                  className="btn-primary w-full text-lg py-4 shadow-lg shadow-primary/30"
                >
